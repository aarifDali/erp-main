...
@section('page-title', __('Manage Debtors'))

@section('page-action')
<div class="d-flex">
    @stack('addButtonHook')
    <div class="text-end d-flex all-button-box justify-content-md-end justify-content-end">
        <a class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create Debtor') }}"
            data-url="{{ route('assistnow-debtors.create') }}" data-toggle="tooltip" title="{{ __('Create') }}">
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="md"
                                            ...
                                            data-url="{{ route('assistnow-debtors.edit', $debtor->id) }}" data-toggle="tooltip"
                                            title="{{ __('Edit') }}">
                                        ...
                                        {!! Form::open([
                                            'method' => 'DELETE',
                                            'route' => ['assistnow-debtors.destroy', $debtor->id],
                                            'id' => 'delete-form-' . $debtor->id,
                                        ]) !!}
                                        ...
                                        <a class="dropdown-item show_confirm text-danger" data-bs-toggle="tooltip" title=""
                                            ...
                                            data-confirm-yes="delete-form-{{ $debtor->id }}"> <i class="ti ti-trash" style="font-size: 18px;margin-right: 10px;"></i>
