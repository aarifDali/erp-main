...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .invoice-header .invoice-details td:first-child {
            font-weight: 900;
        ...
        .invoice-header .invoice-details td:last-child {
        ...
        .total-table tr td:nth-child(2) { /* Apply styles only to value column */
            border-top: 1px solid black; /* Horizontal line for values */
        ...
        .invoice-summary thead th {
            border: 1px solid black; /* Border for the header */
        }
        .invoice-summary tbody td {
            border-left: 1px solid black; /* Vertical borders */
            border-right: 1px solid black;
        }
        .invoice-summary tbody tr:last-child td {
            border-bottom: 1px solid black; /* Add bottom border for the last row */
        }
        .invoice-summary tbody tr:not(:last-child) td {
            border-bottom: none; /* No horizontal lines for non-last rows */
        }
        tfoot {
            border: none;
        }
        ...
        tfoot .total-table tr td {
            border: none !important;
            padding: 5px 0; /* Adjust padding for alignment */
        }

        tfoot .total-table tr td:nth-child(2) {
            border: none !important; /* Remove border for values */
            text-align: right;       /* Ensure right alignment for values */
        }

        tfoot .total-table tr td:nth-child(1) {
            text-align: left;        /* Ensure left alignment for labels */
            border: none !important; /* Remove any left-side border */
        }
    </style>
</head>
            ...
            <table style="margin-bottom: 0;">
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: 900; color:#cae0e6;">
                                {{ __('FACTUUR') }}</h3>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="vertical-align-top company_details" style="margin-top: 0px;">
                <tbody>
                    <tr>
                        <td>
                            <p>
                                ...
                                @if (!empty($settings['company_zipcode']) || !empty($settings['company_city']))
                                    {{ $settings['company_zipcode'] }} {{ $settings['company_city'] }}
                                @endif
                                <br>
                                
                                <!-- Hardcoded website address -->
                                <a href="https://www.geedlaal.nl" target="_blank" style="color: inherit; text-decoration: none;">
                                    www.geedlaal.nl
                                </a>
                                <br>
                        ...
                        <td style="width: 60%;">
                            <table class="no-space invoice-details">
                                <tbody>
                                    <tr>
                                        <td>{{ __('FACTUURN: ') }}</td>
                                        <td class="text-right">
                ...
                <tbody>
                    ...
                    <tr>
                        @if (!empty($customer->billing_name) && !empty($customer->billing_address) && !empty($customer->billing_zip))
                            <td>
                                <strong style="display:block;">{{ __('FACTUURADRES') }}:</strong>
                                <p>
